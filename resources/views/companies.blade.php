            ...
            <div id="lay-fl-con">
                ...
                <div id="lay-fl-mandr">
                    <div id="lay-fl-main">
                            ...
                            <div class="extremes">
                                <div class="trunc">
                                    <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                        ...
                                        <li itemprop="itemListElement" itemtype="http://schema.org/ListItem" itemscope="">
                                            <a itemprop="item" class="p-r" href="/companies?letter={{ $currentLetter }}">
                                                <span itemprop="name">Starts with the letter {{ strtoupper($currentLetter) }}</span>
                        ...
                        <h1>Customer Service Information for Companies Starting with {{ strtoupper($currentLetter) }} - Page {{ $currentPage }} of {{ $totalPages }}</h1>
                        ...
                        <div class="popular-companies">
                            <h3>Most Popular Letter {{ strtoupper($currentLetter) }} Companies ({{ $totalCompanies }} total)</h3>
                        ...
                        @if($totalPages > 1)
                            <div class="pagination">
                                <div class="pagination-container">
                                    @if($currentPage > 1)
                                        <a href="/companies?letter={{ $currentLetter }}&page={{ $currentPage - 1 }}"
                                    ...
                                    @foreach($visiblePages as $page)
                                        ...
                                        @else
                                            <a href="/companies?letter={{ $currentLetter }}&page={{ $page }}"
                    ...
                    <div id="lay-fl-right">
                        ...
                        <div>
                            ...
                            <nav class="list-block mb-u" role="navigation">
                                @foreach(range('a', 'z') as $letter)
                                    <a href="/companies?letter={{ $letter }}">
                                        Companies Starting with {{ strtoupper($letter) }}
                                    </a>
                                @endforeach
                            </nav>
                        </div>
                        ...
                        <div>
                            <div>
                                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                    ...
                                    <li itemprop="itemListElement" itemtype="http://schema.org/ListItem"
                                        itemscope=""><a itemprop="item" class="p-r" href="/companies?letter={{ $currentLetter }}"><span
                                                itemprop="name">Companies Starting with {{ strtoupper($currentLetter) }}</span>
