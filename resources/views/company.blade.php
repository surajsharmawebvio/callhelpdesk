                ...
                <div id="lay-fl-mandr">
                    <div id="lay-fl-main">
                            ...
                            @if(isset($company->questions) && count($company->questions) > 0)
                                @foreach($company->questions as $question)
                                    <div>
                                        ...
                                        <div class="ul-pad mt-r"><span class="bul">A:</span><span>{!! $question->answer ?? '' !!}</span></div>
                                    </div>
                                @endforeach
                            @else
                                <div>
                        ...
                        <div><a name="phone-numbers"></a>
                            ...
                            <div>
                                <div>
                                    <img src="https://picsum.photos/600/200?random=3" alt="Random image"
                                        style="width: 100%; height: 200px; border-radius: 8px; margin: 20px 0;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="lay-fl-right">
                        ...
                        <div>
                            ...
                            <div class="mt-u"><a title="Call {{ $company->name ?? '' }} Customer Service phone number {{ $company->phone ?? '' }}"
                                    href="tel:{{ $company->phone ?? '' }}"><span style="margin-left: 1.5rem;">Call {{ $company->phone ?? '' }} Now</span></a>
                            </div>
                        </div>
                        <h3 class="min" style="margin-bottom: 0.67rem">Compare {{ $company->name ?? '' }} Customer Service</h3>
                        <div class="list-block"><a href="#">AirBnB Customer Service</a><a
                    ...
                    <div class="sec-below">
                        <div>
                            ...
                            <div class="bar-share"><a class="btn-share-f" rel="noopener" target="_blank"
                                    ...
                                    href="http://twitter.com/intent/tweet?text=ACN%20Customer%20Service%20Phone%20Number%20877-226-1010%3A%20Call%20Support&amp;url=https%3A%2F%2Fgethuman.com%2Fphone-number%2FACN">
                                    ...
                                    href="mailto:?body=https%3A%2F%2Fgethuman.com%2Fphone-number%2FACN&subject=ACN%20Customer%20Service%20Phone%20Number%20877-226-1010%3A%20Call%20Support">
                            ...
                            <div>
                                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                                    <li itemprop="itemListElement" itemtype="http://schema.org/ListItem"
                                        itemscope=""><a itemprop="item" class="p-r" href="/companies"><span
                                                itemprop="name">All Companies</span>
                                            <meta itemprop="position" content="1" />
                                        </a><span>&nbsp;&rsaquo;&nbsp;</span></li>
                                    <li itemprop="itemListElement" itemtype="http://schema.org/ListItem"
                                        itemscope=""><a itemprop="item" class="p-r" href="{{ $company->url ?? '#' }}"><span
                                                itemprop="name">{{ $company->name ?? '' }} Customer Service</span>
                                            <meta itemprop="position" content="2" /></a></li>
                                </ol>
                            </div>
                            <div class="small">Updated <time datetime="{{ now()->toIso8601String() }}">{{ now()->format('F d, Y') }}</time></div>
                        </div>
                    </div>
                </div>
            </div>
